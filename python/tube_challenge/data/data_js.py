...
stationsR = dict((stations[key], key) for key in stations.keys())

stationsOnLines = {
    "bakerloo": [
        "940GZZLUBST", "940GZZLUCHX", "940GZZLUEAC", "940GZZLUEMB",
        "940GZZLUERB", "940GZZLUHAW", "940GZZLUHSN", "940GZZLUKEN",
        "940GZZLUKPK", "940GZZLUKSL", "940GZZLULBN", "940GZZLUMVL",
        "940GZZLUMYB", "940GZZLUNWY", "940GZZLUOXC", "940GZZLUPAC",
        "940GZZLUPCC", "940GZZLUQPS", "940GZZLURGP", "940GZZLUSGP",
        "940GZZLUSKT", "940GZZLUWJN", "940GZZLUWKA", "940GZZLUWLO",
        "940GZZLUWYC"
    ],
    "central": [
        "940GZZLUBKE", "940GZZLUBKH", "940GZZLUBLG", "940GZZLUBND",
        "940GZZLUBNK", "940GZZLUCHL", "940GZZLUCWL", "940GZZLUDBN",
        "940GZZLUEAN", "940GZZLUEBY", "940GZZLUEPG", "940GZZLUFLP",
        "940GZZLUGFD", "940GZZLUGGH", "940GZZLUGTH", "940GZZLUHBN",
        "940GZZLUHGR", "940GZZLUHLT", "940GZZLUHPK", "940GZZLULGN",
        "940GZZLULGT", "940GZZLULVT", "940GZZLULYN", "940GZZLULYS",
        "940GZZLUMBA", "940GZZLUMED", "940GZZLUNAN", "940GZZLUNBP",
        "940GZZLUNHG", "940GZZLUNHT", "940GZZLUOXC", "940GZZLUPVL",
        "940GZZLUQWY", "940GZZLURBG", "940GZZLURSG", "940GZZLURVY",
        "940GZZLUSBC", "940GZZLUSNB", "940GZZLUSPU", "940GZZLUSRP",
        "940GZZLUSTD", "940GZZLUSWF", "940GZZLUTCR", "940GZZLUTHB",
        "940GZZLUWCY", "940GZZLUWOF", "940GZZLUWRP", "940GZZLUWSD",
        "940GZZLUWTA"
    ],
    "circle": [
        "940GZZLUALD", "940GZZLUBBN", "940GZZLUBKF", "940GZZLUBST",
        "940GZZLUBWT", "940GZZLUCST", "940GZZLUEMB", "940GZZLUERC",
        "940GZZLUESQ", "940GZZLUFCN", "940GZZLUGHK", "940GZZLUGPS",
        "940GZZLUGTR", "940GZZLUHSC", "940GZZLUHSK", "940GZZLUKSX",
        "940GZZLULAD", "940GZZLULRD", "940GZZLULVT", "940GZZLUMGT",
        "940GZZLUMMT", "940GZZLUMSH", "940GZZLUNHG", "940GZZLUPAC",
        "940GZZLUPAH", "940GZZLURYO", "940GZZLUSBM", "940GZZLUSJP",
        "940GZZLUSKS", "940GZZLUSSQ", "940GZZLUTMP", "940GZZLUTWH",
        "940GZZLUVIC", "940GZZLUWLA", "940GZZLUWSM", "940GZZLUWSP"
    ],
    "district": [
        '940GZZLUACT', '940GZZLUADE', '940GZZLUBBB', '940GZZLUBEC',
        '940GZZLUBKF', '940GZZLUBKG', '940GZZLUBSC', '940GZZLUBWR',
        '940GZZLUBWT', '940GZZLUCST', '940GZZLUCWP', '940GZZLUDGE',
        '940GZZLUDGY', '940GZZLUEBY', '940GZZLUECM', '940GZZLUECT',
        '940GZZLUEHM', '940GZZLUEMB', '940GZZLUEPK', '940GZZLUEPY',
        '940GZZLUERC', '940GZZLUFBY', '940GZZLUGBY', '940GZZLUGTR',
        '940GZZLUHCH', '940GZZLUHSD', '940GZZLUHSK',
        '940GZZLUKOY', '940GZZLUKWG', '940GZZLULAD', '940GZZLULRD',
        '940GZZLUMED', '940GZZLUMMT', '940GZZLUMSH', '940GZZLUNHG',
        '940GZZLUPAC', '940GZZLUPLW', '940GZZLUPSG',
        '940GZZLUPYB', '940GZZLURMD', '940GZZLURVP',
        '940GZZLUSFB', '940GZZLUSFS', '940GZZLUSGN',
        '940GZZLUSJP', '940GZZLUSKS', '940GZZLUSSQ', '940GZZLUTMP',
        '940GZZLUTNG', '940GZZLUTWH', '940GZZLUUPB', '940GZZLUUPK',
        '940GZZLUUPM', '940GZZLUUPY', '940GZZLUVIC', '940GZZLUWBN',
        '940GZZLUWHM', '940GZZLUWIM', '940GZZLUWIP', '940GZZLUWKN',
        '940GZZLUWPL', '940GZZLUWSM'
    ],
    "hammersmith-city": [
        "940GZZLUADE", "940GZZLUBBB", "940GZZLUBBN", "940GZZLUBKG",
        "940GZZLUBST", "940GZZLUBWR", "940GZZLUEHM", "940GZZLUERC",
        "940GZZLUESQ", "940GZZLUFCN", "940GZZLUGHK", "940GZZLUGPS",
        "940GZZLUHSC", "940GZZLUKSX", "940GZZLULAD", "940GZZLULRD",
        "940GZZLULVT", "940GZZLUMED", "940GZZLUMGT", "940GZZLUPAH",
        "940GZZLUPLW", "940GZZLURYO", "940GZZLUSBM", "940GZZLUSGN",
        "940GZZLUUPK", "940GZZLUWHM", "940GZZLUWLA", "940GZZLUWPL",
        "940GZZLUWSP"
    ],
    "jubilee": [
        "940GZZLUBMY", "940GZZLUBND", "940GZZLUBST", "940GZZLUCGT",
        "940GZZLUCPK", "940GZZLUCWR", "940GZZLUCYF", "940GZZLUDOH",
        "940GZZLUFYR", "940GZZLUGPK", "940GZZLUKBN", "940GZZLUKBY",
        "940GZZLULNB", "940GZZLUNDN", "940GZZLUNGW", "940GZZLUQBY",
        "940GZZLUSJW", "940GZZLUSTD", "940GZZLUSTM", "940GZZLUSWC",
        "940GZZLUSWK", "940GZZLUWHM", "940GZZLUWHP", "940GZZLUWIG",
        "940GZZLUWLO", "940GZZLUWSM", "940GZZLUWYP"
    ],
    "metropolitan": [
        "940GZZLUALD", "940GZZLUAMS", "940GZZLUBBN", "940GZZLUBST",
        "940GZZLUCAL", "940GZZLUCSM", "940GZZLUCXY", "940GZZLUCYD",
        "940GZZLUEAE", "940GZZLUESQ", "940GZZLUFCN", "940GZZLUFYR",
        "940GZZLUGPS", "940GZZLUHGD", "940GZZLUHOH", "940GZZLUICK",
        "940GZZLUKSX", "940GZZLULVT", "940GZZLUMGT", "940GZZLUMPK",
        "940GZZLUNHA", "940GZZLUNKP", "940GZZLUNOW", "940GZZLUNWH",
        "940GZZLUPNR", "940GZZLUPRD", "940GZZLURKW", "940GZZLURSM",
        "940GZZLURSP", "940GZZLURYL", "940GZZLUUXB", "940GZZLUWAF",
        "940GZZLUWHW", "940GZZLUWYP"
    ],
    "northern": [
        "940GZZLUACY", "940GZZLUAGL", "940GZZLUBLM", "940GZZLUBNK",
        "940GZZLUBOR", "940GZZLUBTK", "940GZZLUBTX", "940GZZLUBZP",
        "940GZZLUCFM", "940GZZLUCHX", "940GZZLUCND", "940GZZLUCPC",
        "940GZZLUCPN", "940GZZLUCPS", "940GZZLUCSD", "940GZZLUCTN",
        "940GZZLUEAC", "940GZZLUEFY", "940GZZLUEGW", "940GZZLUEMB",
        "940GZZLUEUS", "940GZZLUFYC", "940GZZLUGDG", "940GZZLUGGN",
        "940GZZLUHBT", "940GZZLUHCL", "940GZZLUHGT", "940GZZLUHTD",
        "940GZZLUKNG", "940GZZLUKSH", "940GZZLUKSX", "940GZZLULNB",
        "940GZZLULSQ", "940GZZLUMDN", "940GZZLUMGT", "940GZZLUMHL",
        "940GZZLUMTC", "940GZZLUODS", "940GZZLUOVL", "940GZZLUSKW",
        "940GZZLUSWN", "940GZZLUTAW", "940GZZLUTBC", "940GZZLUTBY",
        "940GZZLUTCR", "940GZZLUTFP", "940GZZLUWFN", "940GZZLUWLO",
        "940GZZLUWOP", "940GZZLUWRR"
    ],
    "piccadilly": [
        "940GZZLUOAK", "940GZZLUACT", "940GZZLUALP", "940GZZLUASG",
        "940GZZLUASL", "940GZZLUBDS", "940GZZLUBOS", "940GZZLUBSC",
        "940GZZLUCAR", "940GZZLUCGN", "940GZZLUCKS", "940GZZLUEAE",
        "940GZZLUECM", "940GZZLUECT", "940GZZLUFPK", "940GZZLUGPK",
        "940GZZLUGTR", "940GZZLUHBN", "940GZZLUHGD", "940GZZLUHNX",
        "940GZZLUHPC", "940GZZLUHR4", "940GZZLUHR5", "940GZZLUHRC",
        "940GZZLUHSD", "940GZZLUHWC", "940GZZLUHWE", "940GZZLUHWT",
        "940GZZLUHWY", "940GZZLUICK", "940GZZLUKNB", "940GZZLUKSX",
        "940GZZLULSQ", "940GZZLUMRH", "940GZZLUNEN", "940GZZLUNFD",
        "940GZZLUOAK", "940GZZLUOSY", "940GZZLUPCC", "940GZZLUPKR",
        "940GZZLURSM", "940GZZLURSP", "940GZZLURSQ", "940GZZLURVP",
        "940GZZLURYL", "940GZZLUSEA", "940GZZLUSFB", "940GZZLUSGT",
        "940GZZLUSHH", "940GZZLUSKS", "940GZZLUSUH", "940GZZLUSUT",
        "940GZZLUTNG", "940GZZLUTPN", "940GZZLUUXB", "940GZZLUWOG"
    ],
    "victoria": [
        "940GZZLUBLR", "940GZZLUBXN", "940GZZLUEUS", "940GZZLUFPK",
        "940GZZLUGPK", "940GZZLUHAI", "940GZZLUKSX", "940GZZLUOXC",
        "940GZZLUPCO", "940GZZLUSKW", "940GZZLUSVS", "940GZZLUTMH",
        "940GZZLUVIC", "940GZZLUVXL", "940GZZLUWRR", "940GZZLUWWL"
    ],
    "waterloo-city": ["940GZZLUBNK", "940GZZLUWLO"]
}

sharedPlatforms = {
    "940GZZLUEMB": [["circle", "district"]],
    "940GZZLUADE": [["district", "hammersmith-city"]],
    "940GZZLUBBB": [["district", "hammersmith-city"]],
    "940GZZLUBBN": [["circle", "hammersmith-city", "metropolitan"]],
    "940GZZLUBWR": [["district", "hammersmith-city"]],
    "940GZZLUEHM": [["district", "hammersmith-city"]],
    "940GZZLUERC": [["circle", "hammersmith-city"], ["circle", "district"]],
    "940GZZLUESQ": [["circle", "hammersmith-city", "metropolitan"]],
    "940GZZLUGHK": [["circle", "hammersmith-city"]],
    "940GZZLUGPS": [["circle", "hammersmith-city", "metropolitan"]],
    "940GZZLULAD": [["circle", "hammersmith-city"]],
    "940GZZLULRD": [["circle", "hammersmith-city"]],
    "940GZZLUPLW": [["district", "hammersmith-city"]],
    "940GZZLUMED": [["district", "hammersmith-city"]],
    "940GZZLURYO": [["circle", "hammersmith-city"]],
    "940GZZLUSBM": [["circle", "hammersmith-city"]],
    "940GZZLUWLA": [["circle", "hammersmith-city"]],
    "940GZZLUSGN": [["district", "hammersmith-city"]],
    "940GZZLUUPK": [["district", "hammersmith-city"]],
    "940GZZLUWSP": [["circle", "hammersmith-city"]],
    "940GZZLUEAE": [["metropolitan", "piccadilly"]],
    "940GZZLUHGD": [["metropolitan", "piccadilly"]],
    "940GZZLUICK": [["metropolitan", "piccadilly"]],
    "940GZZLURSM": [["metropolitan", "piccadilly"]],
    "940GZZLURYL": [["metropolitan", "piccadilly"]],
    "940GZZLURSP": [["metropolitan", "piccadilly"]],
    "940GZZLUBST": [["circle", "hammersmith-city"]],
    "940GZZLUUXB": [["metropolitan", "piccadilly"]],
    "940GZZLUBWT": [["circle", "district"]],
    "940GZZLUGTR": [["circle", "district"]],
    "940GZZLUHSK": [["circle", "district"]],
    "940GZZLUMMT": [["circle", "district"]],
    "940GZZLUSJP": [["circle", "district"]],
    "940GZZLUMSH": [["circle", "district"]],
    "940GZZLUNHG": [["circle", "district"]],
    "940GZZLUSKS": [["circle", "district"]],
    "940GZZLUTMP": [["circle", "district"]],
    "940GZZLUSSQ": [["circle", "district"]],
    "940GZZLUECM": [["district", "piccadilly"]],
    "940GZZLUTNG": [["district", "piccadilly"]]
}
