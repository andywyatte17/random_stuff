...
LD_LIBRARY_PATH=`pwd` \
     ./zimwriterfs --verbose \
              ...
              --favicon="../../../../icon.png" \
              --language=eng \
              --title="OpenEnglishBible" \
              --description="OpenEnglishBible" \
              --creator="OpenEnglishBible" \
              --publisher="OpenEnglishBible" \
              "./openenglishbible/openenglishbible.org/oeb/2016.1/read/" oeb.zim
